...
import com.sample.models.Student;
import com.sample.models.Subject;
import com.sample.models.Teacher;
import com.sample.models.Class;
import java.io.IOException;
import javax.servlet.ServletException;
import javax.servlet.annotation.WebServlet;
import javax.servlet.http.HttpServlet;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (!getCookies(request, response) && (!command.equals("LOGIN"))) {
				...
				response.sendRedirect("/Learner_Acadamy/login.jsp");
			}
